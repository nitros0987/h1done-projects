...
_Assembled Mon 14 Sep 2026. Contains EVERYTHING: decisions, research, meeting pack, and the full source of the live mock-up (https://nitros0987.github.io/h1done-projects/ · repo nitros0987/h1done-projects). Sections separated by --- with a header line._
...
## SECTION 2 — TEACHER MEETING PACK
...
## SECTION 3 — RESEARCH BRIEF 1: SEC/NCCA/AAC/AI RULES
...
## SECTION 4 — RESEARCH BRIEF 2: DATES, LEO GRANT, AI COST MODEL
...
```
---
## SECTION 9 — SOURCE: data/geography-pack.js
```javascript
...
```
---
## SECTION 10 — SOURCE: data/biology-pack.js
```javascript
window.H1_PACKS = window.H1_PACKS || {};
